...
\begin{figure}
\centering
\includegraphics[height=.22\textheight]{{"plot_h0.05_tau2"}.pdf}\\
\includegraphics[height=.22\textheight]{{"plot_h0.05_tau3"}.pdf}\\
\includegraphics[height=.22\textheight]{{"plot_h0.05_tau6"}.pdf}\\
\includegraphics[height=.22\textheight]{{"plot_h0.05_tau10"}.pdf}
