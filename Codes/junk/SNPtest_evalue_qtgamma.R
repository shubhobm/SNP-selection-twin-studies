...
get.outputs.depth = function(signal, rho,
  ...
  loopfun = function(rep){
    ...
    for(isdn in 1:nsdn){
      qt.list = step.depth.qtgamma(mod, sdn=sdn.vec[isdn], q.vec, t.vec)
...
q.vec = c(.95,.9, .5, .2, .1)
t.vec = rev(1:9)/10
# get.outputs.depth(signal=.05, rho=.7, sdn.vec, q.vec, t.vec, nrep, filename="qtg_h05_rho7.Rda")
# get.outputs.depth(signal=.02, rho=.7, sdn.vec, q.vec, t.vec, nrep, filename="qtg_h02_rho7.Rda")
# get.outputs.depth(signal=.01, rho=.7, sdn.vec, q.vec, t.vec, nrep, filename="qtg_h01_rho7.Rda")
# get.outputs.depth(signal=0, rho=.7, sdn.vec, q.vec, t.vec, nrep, filename="qtg_h00_rho7.Rda")
# get.outputs.depth(signal=.1, rho=.7, sdn.vec, q.vec, t.vec, nrep, filename="qtg_h10_rho7.Rda")

nrep = 1e3
get.outputs.depth(signal=.05, rho=.7, sdn.vec, q.vec, t.vec, nrep, filename="qtg_h05_rho7_big.Rda")
get.outputs.depth(signal=.02, rho=.7, sdn.vec, q.vec, t.vec, nrep, filename="qtg_h02_rho7_big.Rda")
get.outputs.depth(signal=.01, rho=.7, sdn.vec, q.vec, t.vec, nrep, filename="qtg_h01_rho7_big.Rda")
get.outputs.depth(signal=0, rho=.7, sdn.vec, q.vec, t.vec, nrep, filename="qtg_h00_rho7_big.Rda")
get.outputs.depth(signal=.1, rho=.7, sdn.vec, q.vec, t.vec, nrep, filename="qtg_h10_rho7_big.Rda")
