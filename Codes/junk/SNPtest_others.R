...
get.outputs.others = function(signal, rho, adj, nrep, filename){
  ...
  loopfun = function(rep){
    ...
    TN0 = 46 - sum((1:p)[best.BIC] %in% (1:p)[-active0])
    TP1 = sum(c(sum(1:6 %in% best.BIC)>0,
                         sum(7:10 %in% best.BIC)>0,
                         sum(41:46 %in% best.BIC)>0,
                         sum(47:50 %in% best.BIC)>0))
    TN1 = 30 - sum((1:p)[best.BIC] %in% (1:p)[-active1])
    out.mat[,1] = c(TP0/4, TN0/46, TP1/4, TN1/30)
    ...
    if(length(which.res)>0){
      best.RF = pval.order[1:which.less]
    }
...
get.outputs.others(signal=.1, rho=.7, adj, nrep, filename="others_h10_rho07.Rda")
get.outputs.others(signal=.05, rho=.7, adj, nrep, filename="others_h05_rho07.Rda")
get.outputs.others(signal=.02, rho=.7, adj, nrep, filename="others_h02_rho07.Rda")
get.outputs.others(signal=.01, rho=.7, adj, nrep, filename="others_h01_rho07.Rda")
get.outputs.others(signal=0, rho=.7, adj, nrep, filename="others_h00_rho07.Rda")

get.outputs.others(signal=.1, rho=.1, adj, nrep, filename="others_h10_rho01.Rda")
get.outputs.others(signal=.05, rho=.1, adj, nrep, filename="others_h05_rho01.Rda")
get.outputs.others(signal=.02, rho=.1, adj, nrep, filename="others_h02_rho01.Rda")
get.outputs.others(signal=.01, rho=.1, adj, nrep, filename="others_h01_rho01.Rda")
get.outputs.others(signal=0, rho=.1, adj, nrep, filename="others_h00_rho01.Rda")

nrep = 1e3
get.outputs.others(signal=.1, rho=.7, adj, nrep, filename="others_h10_rho07_big.Rda")
get.outputs.others(signal=.05, rho=.7, adj, nrep, filename="others_h05_rho07_big.Rda")
get.outputs.others(signal=.02, rho=.7, adj, nrep, filename="others_h02_rho07_big.Rda")
get.outputs.others(signal=.01, rho=.7, adj, nrep, filename="others_h01_rho07_big.Rda")
get.outputs.others(signal=0, rho=.7, adj, nrep, filename="others_h00_rho07_big.Rda")

get.outputs.others(signal=.1, rho=.1, adj, nrep, filename="others_h10_rho01_big.Rda")
get.outputs.others(signal=.05, rho=.1, adj, nrep, filename="others_h05_rho01_big.Rda")
get.outputs.others(signal=.02, rho=.1, adj, nrep, filename="others_h02_rho01_big.Rda")
get.outputs.others(signal=.01, rho=.1, adj, nrep, filename="others_h01_rho01_big.Rda")
get.outputs.others(signal=0, rho=.1, adj, nrep, filename="others_h00_rho01_big.Rda")
