...
get.outputs.fdr = function(signal, rho,
                             sdn.vec, q.vec, t.vec,
                             nrep, filename){
  set.seed(11162016)
  nq = length(q.vec)
  ...
  loopfun = function(rep){
    ...
    for(isdn in 1:nsdn){
      qt.list = step.depth.fdr(mod, sdn=sdn.vec[isdn], q.vec, t.vec)
...
q.vec = c(.95,.9, .5, .2, .1)
t.vec = rev(1:9)/10
# get.outputs.fdr(signal=.1, rho=.7, sdn.vec, q.vec, t.vec, nrep, filename="fdr1_h10_rho7.Rda")
# get.outputs.fdr(signal=.05, rho=.7, sdn.vec, q.vec, t.vec, nrep, filename="fdr1_h05_rho7.Rda")
# get.outputs.fdr(signal=.02, rho=.7, sdn.vec, q.vec, t.vec, nrep, filename="fdr1_h02_rho7.Rda")
# get.outputs.fdr(signal=.01, rho=.7, sdn.vec, q.vec, t.vec, nrep, filename="fdr1_h01_rho7.Rda")
# get.outputs.fdr(signal=0, rho=.7, sdn.vec, q.vec, t.vec, nrep, filename="fdr1_h00_rho7.Rda")

nrep = 1e3
get.outputs.fdr(signal=.1, rho=.7, sdn.vec, q.vec, t.vec, nrep, filename="fdr1_h10_rho7_big.Rda")
get.outputs.fdr(signal=.05, rho=.7, sdn.vec, q.vec, t.vec, nrep, filename="fdr1_h05_rho7_big.Rda")
get.outputs.fdr(signal=.02, rho=.7, sdn.vec, q.vec, t.vec, nrep, filename="fdr1_h02_rho7_big.Rda")
get.outputs.fdr(signal=.01, rho=.7, sdn.vec, q.vec, t.vec, nrep, filename="fdr1_h01_rho7_big.Rda")
get.outputs.fdr(signal=0, rho=.7, sdn.vec, q.vec, t.vec, nrep, filename="fdr1_h00_rho7_big.Rda")
