...
get.outputs.depth = function(signal, rho,
  ...
  loopfun = function(rep){
    ...
    for(j in 1:nt){
      ...
      best.result[j,] = (result.list[[best.sdn]])[-5,j]/c(4,46,4,30)
    }
...
# get.outputs.depth(signal=.07, rho=.7, Emap, sdn.vec, q.vec, t.vec, nrep, filename="E2_h07_rho7_big.Rda")
...
# Emap = "E1"
# t.vec = exp(-(1:5))
# get.outputs.depth(signal=.1, rho=.7, sdn.vec, q.vec, t.vec, nrep, filename="E1_h10_rho7_big.Rda")
# get.outputs.depth(signal=.07, rho=.7, sdn.vec, q.vec, t.vec, nrep, filename="E1_h07_rho7_big.Rda")
# get.outputs.depth(signal=.05, rho=.7, sdn.vec, q.vec, t.vec, nrep, filename="E1_h05_rho7_big.Rda")
# get.outputs.depth(signal=.03, rho=.7, sdn.vec, q.vec, t.vec, nrep, filename="E1_h03_rho7_big.Rda")
# get.outputs.depth(signal=.02, rho=.7, sdn.vec, q.vec, t.vec, nrep, filename="E1_h02_rho7_big.Rda")
# get.outputs.depth(signal=.01, rho=.7, sdn.vec, q.vec, t.vec, nrep, filename="E1_h01_rho7_big.Rda")
# get.outputs.depth(signal=0, rho=.7, sdn.vec, q.vec, t.vec, nrep, filename="E1_h00_rho7_big.Rda")
