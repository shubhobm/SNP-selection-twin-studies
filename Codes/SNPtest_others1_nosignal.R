...
get.outputs.others = function(signal, rho, adj, nrep, filename){
  ...
  loopfun = function(rep){
    out.mat = matrix(0, nrow=2, ncol=2)
    ...
    TP1 = sum(c(sum(1:5 %in% best.BIC)>0,
                sum(6:8 %in% best.BIC)>0,
                sum(39:43 %in% best.BIC)>0,
                sum(44:46 %in% best.BIC)>0))
    TN1 = 30 - sum((1:p)[best.BIC] %in% (1:p)[-active1])
    out.mat[,1] = c(TP1/4, TN1/30)
    ...
    TP1 = sum(c(sum(1:5 %in% best.RF)>0,
                sum(6:8 %in% best.RF)>0,
                sum(39:43 %in% best.RF)>0,
                sum(44:46 %in% best.RF)>0))
    TN1 = 30 - sum((1:p)[best.RF] %in% (1:p)[-active1])
    out.mat[,2] = c(TP1/4, TN1/30)
...
nrep = 1e3
get.outputs.others(signal=.1, rho=.9, adj, nrep, filename="others1_h10_rho07_nosignal.Rda")
get.outputs.others(signal=.07, rho=.9, adj, nrep, filename="others1_h07_rho07_nosignal.Rda")
get.outputs.others(signal=.05, rho=.9, adj, nrep, filename="others1_h05_rho07_nosignal.Rda")
get.outputs.others(signal=.03, rho=.9, adj, nrep, filename="others1_h03_rho07_nosignal.Rda")
get.outputs.others(signal=.02, rho=.9, adj, nrep, filename="others1_h02_rho07_nosignal.Rda")
get.outputs.others(signal=.01, rho=.9, adj, nrep, filename="others1_h01_rho07_nosignal.Rda")
get.outputs.others(signal=0, rho=.9, adj, nrep, filename="others1_h00_rho07_nosignal.Rda")

# get.outputs.others(signal=.1, rho=.1, adj, nrep, filename="others1_h10_rho01_nosignal.Rda")
# get.outputs.others(signal=.07, rho=.1, adj, nrep, filename="others1_h07_rho01_nosignal.Rda")
# get.outputs.others(signal=.05, rho=.1, adj, nrep, filename="others1_h05_rho01_nosignal.Rda")
# get.outputs.others(signal=.03, rho=.1, adj, nrep, filename="others1_h03_rho01_nosignal.Rda")
# get.outputs.others(signal=.02, rho=.1, adj, nrep, filename="others1_h02_rho01_nosignal.Rda")
# get.outputs.others(signal=.01, rho=.1, adj, nrep, filename="others1_h01_rho01_nosignal.Rda")
# get.outputs.others(signal=0, rho=.1, adj, nrep, filename="others1_h00_rho01_nosignal.Rda")
# 
# 
