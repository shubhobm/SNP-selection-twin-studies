...
# nrep = 8
# t.vec = seq(.8, .5, by=-.03)
# get.outputs.depth(signal=.1, rho=.9, Emap, sdn.vec, q.vec, t.vec, nrep, filename="E2_h10_rho7_nosignal.Rda")
# get.outputs.depth(signal=.07, rho=.9, Emap, sdn.vec, q.vec, t.vec, nrep, filename="E2_h07_rho7_nosignal.Rda")
